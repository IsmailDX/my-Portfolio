...
const Index = ({ items }: Props) => {
  ...
  useEffect(() => {
    ...
    if (colorMode === "dark") {
      imageUrl = "/images/preload-index-dark.webp";
      blurImageUrl =
      ...
      imageUrl = "/images/preload-index-light.webp";
      blurImageUrl =
          ...
          (item) =>
            item.colorMode === colorMode && (
              ...
              >
                ...
                <Image
                  src={image ? image : "/images/preload-index-dark.webp"}
                  alt={item.name}
                  width={1920}
                  height={1080}
                  className={`${
                ...
                <video
                  ...
                  className={`h-full object-center object-cover pointer-events-none z-0 ${
                    videoLoaded === true ? "w-full" : "w-0 opacity-0"
                  }`}
                  preload="auto"
